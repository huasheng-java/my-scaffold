...
//         gc.setControllerName("%s");
        ...
        dsc.setUsername("toolmall");
        dsc.setPassword("123456");
        dsc.setUrl("jdbc:mysql://192.168.100.179:3306/scaffold?characterEncoding=utf-8&useSSL=false");
...
//        strategy.setExclude(new String[]{"sys_user_role","sys_role_menu","sys_group_ur"}); // 排除生成的表
        // 自定义实体父类
        strategy.setSuperEntityClass("com.my.scaffold.base.DataEntity");
        // 自定义实体，公共字段
...
//        tc.setController("/templates/vm/action.java.vm");
