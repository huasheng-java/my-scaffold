...
import com.my.scaffold.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.my.scaffold.annotation.SysLog mylog = method.getAnnotation(com.my.scaffold.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
